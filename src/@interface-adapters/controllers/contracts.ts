...
import type { CompletePasswordRecoveryController } from "./auth/CompletePasswordRecoveryController";
...
import type { DeleteAccountController } from "./auth/DeleteAccountController";
...
import type { ImportProjectController } from "./project/ImportProjectController";
...
export interface ControllerInstanceMap {
    ...
    auth: {
        ...
        completePasswordRecovery: CompletePasswordRecoveryController;
